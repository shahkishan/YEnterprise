<template>
	<v-container fluid grid-list-md text-xs-center mt-3 pl-3 pr-3 v-if="container">
		<v-layout row wrap pl-5 pr-5>
			<v-flex d-flex xs12 md3 sm6 pr-3 mt-5 mb-3>
				<v-card dark color="amber darken-1" height="200px" width="90%" raised hover="" class="item" @click.native="$router.push('Users')">
			...
			<v-flex d-flex xs12 md3 sm6 pr-3 mt-5 mb-3>
				<v-card dark color="lime darken-3" height="200px" width="90%" raised hover="" class="item" @click.native="$router.push('Customers')">
			...
			<v-flex d-flex xs12 md3 sm6 pr-3 mt-5 mb-3>
				<v-card dark color="purple darken-2" height="200px" width="90%" raised hover="" class="item" @click.native="$router.push('Suppliers')">
					<svg class="myIcon" viewBox="0 0 24 24">
